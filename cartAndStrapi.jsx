...
const Products = (props) => {
  ...
  const [query, setQuery] = useState("http://localhost:1337/api/products?populate=*");
  ...
  const prod = ()=> {
     ...
     //let imgUrl = item.attributes.image.data.attributes.formats.thumbnail.url //
  ...
  return (
    <Container>
      <Row>
        <Col>
          <h3>Product List</h3>
          <button onClick={prod}>Load products</button>
